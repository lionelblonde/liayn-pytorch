...
def wrap_deepmind(env, episode_life=True, clip_rewards=False, frame_stack=True, scale=False):
...
def wrap_atari(env, max_episode_steps=None, use_deepmind_wrapper=True):
